...
function MostrarRegistro(){
    //declaramos una visivle para guardar los datos
    var listaregistro=Mostrar();
    //selecciono el tbody de la tabla donde voy a mostrar la imformacion
...
//llamamos al procedimiento en el aevento del boton
// btnRegistrar.addEventListener("click",Mensaje)

//llamamos al procedimiento registarar en el evento del boton
